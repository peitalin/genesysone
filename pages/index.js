      ...
      return (
        <div className="landing-page-header-container" key="en">
          <div className="landing-page-header landing-page-header-anim">
            ...
            <div> <h2>Decentralized Infrastructures.</h2> </div>
          </div>
          <div className="landing-page-sub-header">
            <h3>GenesysOne are patient investors.</h3>
            <p className="psmall">
            We invest in decentralized infrastructures and marketplaces with strong network effects. <br/>Built by thoughtful founders.<br/>Governed by diverse communities.
            </p>
          </div>
        </div>
      );
